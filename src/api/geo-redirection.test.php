...
require_once dirname(__DIR__, 2) .
    "/phpunit/test-helpers/MockLocationHelper.php";
...
class TestGeoRedirectionApi extends WP_UnitTestCase
{
     ...
     */
    private function do_api_request($request)
    {
    ...
    public function test_get_redirections_api_permissions()
    {
        ...
        $response = $this->do_api_request(
            new WP_REST_Request("GET", "/maki-geo/v1/redirections")
        );
        $this->assertEquals(
            403,
            $response->get_status(),
            "Subscriber should receive a 403 Forbidden status."
        ); // Or 401 depending on exact permission check
        ...
        $this->assertEquals(
            200,
            $response->get_status(),
            "Admin should receive a 200 OK status."
        );
    }
    ...
    public function test_get_redirections_api_success()
    {
                    ...
                    [
                        ...
                        "redirectMappings" => [
                            [
                                "id" => "map_1",
                                "fromUrl" => "/about",
                                "toUrl" => "https://example.co.uk/about-us",
                            ],
                        ],
                        "exclusions" => [
                            [
        ...
        $this->assertEquals(
            $mock_redirections,
            $data,
            "Response data should match the mocked option data."
        );
    ...
    public function test_get_redirections_api_empty()
    {
        ...
        $this->assertEquals(
            [],
            $data,
            "Response data should be an empty array when no redirections exist."
        );
    }
    ...
    public function test_create_redirection_api_permissions()
    {
        ...
        $this->assertEquals(
            403,
            $response->get_status(),
            "Subscriber should receive a 403 Forbidden status when trying to create."
        );
    }
    ...
    public function test_create_redirection_api_success()
    {
        ...
        $this->assertArrayHasKey(
            "redirection",
            $data,
            "Response should contain the created redirection."
        );

        $created_redirection = $data["redirection"];
        $this->assertIsString(
            $created_redirection["id"],
            "Created redirection should have an ID."
        );
        $this->assertStringStartsWith(
            "red_",
            $created_redirection["id"],
            'Redirection ID should start with "red_".'
        );
        $this->assertEquals(
            $new_redirection_data["name"],
            $created_redirection["name"],
            "Redirection name should match input."
        );
        $this->assertEquals(
            $new_redirection_data["isEnabled"],
            $created_redirection["isEnabled"],
            "Redirection isEnabled should match input."
        );
        $this->assertCount(
            1,
            $created_redirection["locations"],
            "Created redirection should have one location."
        );
        $this->assertStringStartsWith(
            "loc_",
            $created_redirection["locations"][0]["id"],
            'Location ID should start with "loc_".'
        );
        $this->assertEquals(
            $new_redirection_data["locations"][0]["conditions"],
            $created_redirection["locations"][0]["conditions"],
            "Location conditions should match input."
        );
        ...
        $this->assertIsArray(
            $stored_redirections,
            "Stored option should be an array."
        );
        $this->assertCount(
            1,
            $stored_redirections,
            "Stored option should contain one redirection."
        );
        // Compare the stored redirection with the one returned in the response
        $this->assertEquals(
            $created_redirection,
            $stored_redirections[0],
            "Stored redirection should match the response redirection."
        );
    }
    ...
    public function test_create_redirection_api_invalid_data()
    {
        ...
        $response1 = $this->do_api_request($request1);
        $data1 = $response1->get_data();

        $this->assertEquals(
            400,
            $response1->get_status(),
            "Response status should be 400 Bad Request for missing locations."
        );
        $this->assertFalse(
            $data1["success"],
            "Response should indicate failure for missing locations."
        );
        $this->assertArrayHasKey(
            "message",
            $data1,
            "Response should contain an error message for missing locations."
        );
        ...
        $response2 = $this->do_api_request($request2);
        $data2 = $response2->get_data();

        $this->assertEquals(
            400,
            $response2->get_status(),
            "Response status should be 400 Bad Request for empty conditions."
        );
        $this->assertFalse(
            $data2["success"],
            "Response should indicate failure for empty conditions."
        );
        $this->assertArrayHasKey(
            "message",
            $data2,
            "Response should contain an error message for empty conditions."
        );
        ...
        $this->assertEmpty(
            $stored_redirections,
            "Stored option should remain empty after invalid attempts."
        );
    }
    ...
    public function test_update_redirection_api_permissions()
    {
        ...
        $request = new WP_REST_Request(
            "PUT",
            "/maki-geo/v1/redirections/some_id"
        );
        ...
        $this->assertEquals(
            403,
            $response->get_status(),
            "Subscriber should receive a 403 Forbidden status when trying to update."
        );
    }
    ...
    public function test_update_redirection_api_success()
    {
        ...
        $updated_data["locations"][0]["redirectUrl"] =
            "https://example.com/updated";

        $request = new WP_REST_Request(
            "PUT",
            "/maki-geo/v1/redirections/" . $initial_redirection_id
        );
        ...
        $this->assertArrayHasKey(
            "redirection",
            $data,
            "Response should contain the updated redirection."
        );
        $this->assertEquals(
            $updated_data,
            $data["redirection"],
            "Response redirection data should match the updated data."
        );
        ...
        $this->assertEquals(
            $updated_data,
            $stored_redirections[0],
            "Stored redirection should match the updated data."
        );
    }
    ...
    public function test_update_redirection_api_not_found()
    {
        ...
        $request = new WP_REST_Request(
            "PUT",
            "/maki-geo/v1/redirections/" . $non_existent_id
        );
    ...
    public function test_update_redirection_api_invalid_data()
    {
        ...
        $this->assertEquals(
            $initial_redirection,
            $stored_redirections[0],
            "Stored redirection should remain unchanged."
        );
    }
    ...
    public function test_update_redirection_api_id_mismatch()
    {
        ...
        $request = new WP_REST_Request(
            "PUT",
            "/maki-geo/v1/redirections/" . $original_id
        );
        ...
        $this->assertEquals(
            400,
            $response->get_status(),
            "Response status should be 400 Bad Request due to ID mismatch."
        );
        $this->assertFalse(
            $data["success"],
            "Response should indicate failure."
        ...
        $this->assertArrayHasKey(
            "message",
            $data,
            "Response should contain an error message about ID mismatch."
        );
        ...
        $this->assertEquals(
            $initial_redirection,
            $stored_redirections[0],
            "Stored redirection should remain unchanged after ID mismatch attempt."
        );
    }
    ...
    public function test_delete_redirection_api_permissions()
    {
        ...
        $this->assertEquals(
            403,
            $response->get_status(),
            "Subscriber should receive a 403 Forbidden status when trying to delete."
        );
    }
    ...
    public function test_delete_redirection_api_success()
    {
        ...
        update_option("mgeo_redirections", [
            $redirection_to_delete,
            $redirection_to_keep,
        ]);
        ...
        $request = new WP_REST_Request(
            "DELETE",
            "/maki-geo/v1/redirections/" . $id_to_delete
        );
        ...
        $this->assertEquals(
            200,
            $response->get_status(),
            "Response status should be 200 OK for successful deletion."
        );
        $this->assertTrue(
            $data["success"],
            "Response should indicate success."
        ...
        $this->assertIsArray(
            $stored_redirections,
            "Stored option should still be an array."
        );
        $this->assertCount(
            1,
            $stored_redirections,
            "Stored option should contain only one redirection after deletion."
        );
        $this->assertEquals(
            $id_to_keep,
            $stored_redirections[0]["id"],
            "The remaining redirection should be the one intended to be kept."
        );
        $this->assertEquals(
            $redirection_to_keep,
            $stored_redirections[0],
            "The remaining redirection data should match the one intended to be kept."
        );
    }
    ...
    public function test_delete_redirection_api_not_found()
    {
        ...
        $this->assertEquals(
            404,
            $response->get_status(),
            "Response status should be 404 Not Found when deleting non-existent ID."
        );
        $this->assertFalse(
            $data["success"],
            "Response should indicate failure."
    ...
    public function test_handle_redirection_api_no_redirect()
    {
        ...
        $filter_callback = function ($original_result, $url_arg) use (
            $referer_url
        ) {
            $this->assertEquals(
                $referer_url,
                $url_arg,
                "mgeo_get_redirect_url_for_request called with correct URL"
            );
            return null;
        };
        add_filter(
            "mgeo_get_redirect_url_for_request",
            $filter_callback,
            10,
            2
        );
        ...
        $this->assertEquals(
            ["redirect" => false],
            $data,
            "Response should indicate no redirect."
        );
    ...
    public function test_handle_redirection_api_no_referer()
    {
        ...
        $this->assertEquals(
            ["redirect" => false],
            $data,
            "Response should indicate no redirect when referer is missing."
        );
    }
    ...
    public function test_handle_redirection_api_nonce_failure()
    {
        ...
        $this->assertEquals(
            403,
            $response->get_status(),
            "Response status should be 403 Forbidden due to nonce failure."
        );
    ...
    public function test_sanitize_single_redirection_valid()
    {
        ...
        $sanitized_with_ids = mgeo_sanitize_single_redirection(
            $valid_input_with_ids
        );
        $this->assertEquals("red_myid", $sanitized_with_ids["id"]);
        $this->assertEquals(
            "loc_myloc",
            $sanitized_with_ids["locations"][0]["id"]
        );
        $this->assertEquals(
            "map_mymap",
            $sanitized_with_ids["locations"][0]["redirectMappings"][0]["id"]
        );
        $this->assertEquals(
            "excl_myexcl",
            $sanitized_with_ids["locations"][0]["exclusions"][0]["id"]
        );
        $this->assertFalse($sanitized_with_ids["isEnabled"]);
        $this->assertEquals(
            "AND",
            $sanitized_with_ids["locations"][0]["operator"]
        );
        $this->assertEquals(
            "specific",
            $sanitized_with_ids["locations"][0]["pageTargetingType"]
        );
    ...
    public function test_sanitize_single_redirection_invalid_types()
    {
        ...
        $this->assertNull(
            $sanitized,
            "Redirection should be invalid if locations is not an array"
        );
        ...
        $this->assertNull(
            $sanitized,
            "Redirection should be invalid if a location item is not an array"
        );
        ...
        $this->assertNull(
            $sanitized,
            "Redirection should be invalid if conditions is not an array"
        );
        ...
        $this->assertNull(
            $sanitized,
            "Redirection should be invalid if a condition item is not an array"
        );
        ...
        $this->assertNull(
            $sanitized,
            "Redirection should be invalid if redirectMappings is not an array"
        );
    ...
    public function test_sanitize_single_redirection_invalid_enums()
    {
        ...
        $this->assertEquals(
            "country",
            $sanitized["locations"][0]["conditions"][0]["type"]
        ); // Defaults to country
        ...
        $this->assertEquals(
            "is",
            $sanitized["locations"][0]["conditions"][0]["operator"]
        ); // Defaults to is
        ...
        $this->assertEquals(
            "all",
            $sanitized["locations"][0]["pageTargetingType"]
        ); // Defaults to all

        // Invalid exclusion type
        $input = $this->get_valid_redirection_data_base();
        $input["locations"][0]["exclusions"] = [
            ["type" => "cookie_present", "value" => "test"],
        ];
        $sanitized = mgeo_sanitize_single_redirection($input);
        $this->assertEquals(
            "url_equals",
            $sanitized["locations"][0]["exclusions"][0]["type"]
        ); // Defaults to url_equals
    }
    ...
    public function test_sanitize_single_redirection_empty_values()
    {
        ...
        $this->assertNull(
            $sanitized,
            "Redirection should be invalid if the only condition has an empty value"
        );

        // Add a valid condition alongside an empty one
        $input = $this->get_valid_redirection_data_base();
        $input["locations"][0]["conditions"][] = [
            "type" => "region",
            "value" => "",
            "operator" => "is",
        ];
        ...
        $this->assertCount(
            1,
            $sanitized["locations"][0]["conditions"],
            "Condition with empty value should be removed"
        );
        $this->assertEquals(
            "US",
            $sanitized["locations"][0]["conditions"][0]["value"]
        );

        // Empty mapping fromUrl
        $input = $this->get_valid_redirection_data_base();
        $input["locations"][0]["pageTargetingType"] = "specific";
        $input["locations"][0]["redirectMappings"] = [
            ["fromUrl" => "", "toUrl" => "https://example.com/a"],
        ];
        $sanitized = mgeo_sanitize_single_redirection($input);
        $this->assertNull(
            $sanitized,
            "Redirection should be invalid if the only mapping has empty fromUrl"
        );
        ...
        $this->assertNull(
            $sanitized,
            "Redirection should be invalid if the only mapping has empty toUrl"
        );
        ...
        $this->assertIsArray($sanitized);
        $this->assertEmpty(
            $sanitized["locations"][0]["exclusions"],
            "Exclusion with empty value should be removed"
        );
    }
    ...
    public function test_sanitize_single_redirection_cross_field_rules()
    {
        ...
        $this->assertNull(
            $sanitized,
            "Redirection should be invalid if type is 'all' but redirectUrl is empty"
        );
        ...
        $this->assertNull(
            $sanitized,
            "Redirection should be invalid if type is 'specific' but redirectMappings is empty"
        );
        ...
        $input["locations"][0]["redirectMappings"] = [
            ["fromUrl" => "/from", "toUrl" => "https://to.example.com"],
        ];
        $sanitized = mgeo_sanitize_single_redirection($input);
        $this->assertIsArray($sanitized);
        $this->assertEquals(
    ...
    public function test_sanitize_single_redirection_url_sanitization()
    {
        ...
        $this->assertNull(
            $sanitized,
            "Redirection should be invalid if redirectUrl is sanitized away for 'all' type"
        );

        // redirectUrl with valid but complex URL
        $input = $this->get_valid_redirection_data_base();
        $complex_url =
            "https://user:pass@example.com:8080/path/to/page?query=val&q2=v2#fragment";
        $input["locations"][0]["redirectUrl"] = $complex_url;
        $sanitized = mgeo_sanitize_single_redirection($input);
        $this->assertEquals(
            $complex_url,
            $sanitized["locations"][0]["redirectUrl"],
            "Valid complex URL should pass esc_url_raw"
        );
        ...
        $input["locations"][0]["redirectUrl"] = "";
        $input["locations"][0]["redirectMappings"] = [
            ["fromUrl" => "/safe", "toUrl" => 'javascript:alert("XSS")'],
        ];
        $sanitized = mgeo_sanitize_single_redirection($input);
        // The mapping itself becomes invalid because toUrl is empty after sanitization
        $this->assertNull(
            $sanitized,
            "Redirection should be invalid if mapping toUrl is sanitized away"
        );
        ...
        $this->assertEquals(
            "../relative/path",
            $sanitized["locations"][0]["redirectMappings"][0]["fromUrl"]
        );
        ...
        $input["locations"][0]["redirectMappings"] = [
            [
                "fromUrl" => '/path<script>alert("bad")</script>',
                "toUrl" => "https://example.com/target",
            ],
        ];
        $sanitized = mgeo_sanitize_single_redirection($input);
    ...
    public function test_sanitize_redirections_valid_and_invalid()
    {
        ...
        $input_array = [$invalid_redir_1, $valid_redir, $invalid_redir_2];
        ...
        $this->assertCount(
            1,
            $sanitized_array,
            "Only the valid redirection should remain"
        );
        $this->assertEquals(
            "red_valid",
            $sanitized_array[0]["id"],
            "The remaining redirection should be the valid one"
        );
        // Deep check one field to be sure it's the sanitized version
        $this->assertEquals(
            "https://example.com/us",
            $sanitized_array[0]["locations"][0]["redirectUrl"]
        );
    }
